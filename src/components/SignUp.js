...
class SignUp extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.setState({
            emailError: "Email already in use, please use another email"
        });
        } else {
    ...
    onBlurPasswordHandler = e => {
        ...
        if (password !== confirmpassword) {
            this.setState({
            passwordError: "Password does not match to the  confirm password!"
            });
        } else {
    ...
    onBlurConfirmPasswordHanlder = () => {
        ...
        if (password !== confirmpassword) {
            this.setState({
            passwordError: "Confirm password does not match to the password!"
            });
        } else {
            this.setState({ passwordError: "" });
        }
        ...
        return (
            ...
            <Grid item xs={12} md={6}>
                ...
                <Grid container spacing={8} className="LoginContainer">
                    ...
                    <select name="province" onChange={this.onSelectHandler} className="selectSignUp">
                        ...
                        <option value="Islāmābād">Islāmābād</option>
                        <option value="Balochistān">Balochistān</option>
                    ...
                    <Grid item xs={12} md={12} align="center" className="paddingTop">
                        <Button onClick={this.onSubmitHandler} disabled={isvalid} type="submit" variant="contained" size="small" color="primary" className="singUpBtn">
                            { loading ? (<CircularProgress size={20} />) : (<span>Submit
